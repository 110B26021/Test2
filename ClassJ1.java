	...
	public static void main(String[] args) {
		...
		outsideloop: for (int j = 1; j <= 3; j++) {
			insideloop: for (int i = 1; i <= 3; i++) {
				...
				/*
				 * //if 001 if (i==3) { System.out.println("EROR"); break outsideloop; } //if
				 * 002 if ( setpass1 < 0 || setpass1 > 9999 ){ System.out.println("請再輸入一次密碼\n");
				 * } //if 003 if ( setpass2 < 0 || setpass2 > 9999 ){
				 * System.out.println("請再輸入一次密碼\n"); }
				 * 
				 */
